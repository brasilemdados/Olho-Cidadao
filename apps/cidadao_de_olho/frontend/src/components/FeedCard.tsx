...
export function FeedCard({ item, textos }: FeedCardProps) {
  ...
  return (
    <article className="relative overflow-hidden rounded-4xl border border-white/10 bg-[#10131d]/92 p-5 shadow-[0_30px_80px_rgba(7,10,16,0.45)] backdrop-blur">
      <div
        className={`pointer-events-none absolute inset-x-0 top-0 h-1 bg-linear-to-r ${modelo.accentClassName}`}
      />
